                    ...
                    <form action="#" method=post style="padding-bottom: 50px">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <label style="min-width: 300px">You
                                got <?=$material_item->getCurrentCount()?> <?=$material_item->getName()?></label>
                            <div class="col-auto">
                                <input name="<?=$material_item->getId()?>_quantity" type="input" class="form-control"
                                       value="<?=$material_item->getCurrentCount()?>">
                            </div>
                            <!--
                            <div class="mb-3">
                                    ...
                                    foreach ($material_item->getHistory() as $history_time_span) {
                                        ...
                                        <div class="card text-white <?=$bg?> col-sm-5"
                                            ...
                                            <div class="card-body" style="padding: 5px;">
                                                ...
                                                <ul>
                                                    <li>
                                                        Gained <?=$history_time_span->getNetGains()?> <?=$material_item->getName()?>s
                                                    </li>
                                                    <li>
                                                        Spent <?=$history_time_span->getNetLoss()?> <?=$material_item->getName()?>s
                                                    </li>
                                                </ul>
                                                Overall, you
                                                got <?=$history_time_span->get_overall_change()?> <?=$material_item->getName()?>
                                                        ...
                                                        <div class="modal-bg modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>In
                                                                        total, <?=$history_time_span->get_overall_change()?> <?=$material_item->getName()?>s
                                                                    </li>
                                                                </ul>
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        Gained <?=$history_time_span->get_average_gain()?> <?=$material_item->getName()?>s / day
                                                                    </li>
                                                                    <li>
                                                                        Spent <?=$history_time_span->get_average_loss()?> <?=$material_item->getName()?>s / day
                                                                    </li>
                                                                    <li>In
                                                                        average, <?=$history_time_span->get_average_change()?> <?=$material_item->getName()?>s / day
                                                                    </li>
                                                                </ul>
                                                            </div>
